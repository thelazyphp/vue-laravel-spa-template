<template>
    <div class="nca-isolateds-filter-wrapper">
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="col-lg-4 form-group">
                <label for="capital-type-filter">{{ $t('nca.filter.isolateds.capital_type.label') }}</label>
                <select
                    id="capital-type-filter"
                    v-model="filter.capital_type"
                    class="form-control form-control-sm"
                >
                    <option
                        value=""
                        selected
                    >
                        {{ $t('nca.filter.isolateds.capital_type.any') }}
                    </option>
                    <option
                        v-for="capitalType in (options['capital_type'] || [])"
                        :key="capitalType"
                        :value="capitalType"
                    >
                        {{ capitalType }}
            ...
            <div class="col-lg-4 form-group">
                <label for="capital-role-filter">{{ $t('nca.filter.isolateds.capital_role.label') }}</label>
                <select
                    id="capital-role-filter"
                    v-model="filter.capital_role"
                    class="form-control form-control-sm"
                >
                    <option
                        value=""
                        selected
                    >
                        {{ $t('nca.filter.isolateds.capital_role.any') }}
                    </option>
                    <option
                        v-for="capitalRole in (options['capital_role'] || [])"
                        :key="capitalRole"
                        :value="capitalRole"
                    >
                        {{ capitalRole }}
            ...
            <div class="col-lg-4 form-group">
                <label for="walls-type-filter">{{ $t('nca.filter.isolateds.walls_type.label') }}</label>
                <select
                ...
                >
                    <option
                        ...
                        selected
                    >
                        {{ $t('nca.filter.isolateds.walls_type.any') }}
                    </option>
                    <option
        ...
        <div class="form-row">
            <div class="col-lg-4 form-group">
                <label for="rooms-count-filter">{{ $t('nca.filter.isolateds.rooms_count.label') }}</label>
                <div class="input-group input-group-sm">
                    <input
                        id="rooms-count-filter"
                        v-model="filter.rooms_count_min"
                        type="number"
                        min="1"
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.rooms_count.min')"
                    >
                    <input
                        v-model="filter.rooms_count_max"
                        type="number"
                        min="1"
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.rooms_count.max')"
                    >
                </div>
            </div>
            <div class="col-lg-4 form-group">
                <label for="floor-filter">{{ $t('nca.filter.isolateds.floor.label') }}</label>
                <div class="input-group input-group-sm">
                    <input
                        id="floor-filter"
                        v-model="filter.floor_min"
                        type="number"
                        min="1"
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.floor.min')"
                    >
                    <input
                        v-model="filter.floor_max"
                        type="number"
                        min="1"
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.floor.max')"
                    >
                </div>
            </div>
            <div class="col-lg-4 form-group">
                <label for="floors-total-filter">{{ $t('nca.filter.isolateds.floors_total.label') }}</label>
                <div class="input-group input-group-sm">
                    <input
                        ...
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.floors_total.min')"
                    >
                    <input
                        ...
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.floors_total.max')"
                    >
                </div>
            </div>
        </div>
        <div class="form-row">
            <div class="col-lg-4 form-group">
                <label for="size-filter">{{ $t('nca.filter.isolateds.size.label') }}</label>
                <div class="input-group input-group-sm">
                    <input
                        id="size-filter"
                        ...
                        :placeholder="$t('nca.filter.isolateds.size.min')"
                        :aria-label="$t('nca.filter.isolateds.size.aria-label')"
                    >
                    <input
                        ...
                        :placeholder="$t('nca.filter.isolateds.size.max')"
                        :aria-label="$t('nca.filter.isolateds.size.aria-label')"
                    >
                    <div class="input-group-append">
                        ...
                        >
                            {{ $t('nca.filter.isolateds.size.addon') }}<sup>2</sup>
                        </span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 form-group">
                <label for="construction-year-filter">{{ $t('nca.filter.isolateds.construction_year.label') }}</label>
                <div class="input-group input-group-sm">
                    <input
                        ...
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.construction_year.min')"
                    >
                    <input
                        ...
                        step="1"
                        class="form-control"
                        :placeholder="$t('nca.filter.isolateds.construction_year.max')"
                    >
                </div>
            </div>
            <div class="col-lg-4 form-group">
...
<script>
    export default {
        ...
        data () {
            return {
                filter: {
                    ...
                    capital_role: '',
                    walls_type: '',
                    rooms_count_min: null,
                    rooms_count_max: null,
                    floor_min: null,
                    floor_max: null,
        ...
        watch: {
            ['filter.rooms_count_min'] (value) {
                this.filter.rooms_count_max = value
            },

            ['filter.floor_min'] (value) {
                this.filter.floor_max = value
            },
        ...
        methods: {
            resetFilter () {
                ...
                this.filter.type = ''
                this.filter.role = ''
                this.filter.capital_type = ''
                this.filter.capital_role = ''
                this.filter.walls_type = ''
                this.filter.rooms_count_min = null
                this.filter.rooms_count_max = null
                this.filter.floor_min = null
                this.filter.floor_max = null
